...
A simple static UI is available under `frontend/public/index.html`. When the project is running it is served on **http://localhost:8080** (see docker-compose). It interacts with the API gateway and allows basic operations such as user registration, login, doctor affiliation and appointment creation.
